...
def generate_response_based_on_course_details(user_message, product_details):
    ...
    Your response should be comprehensive and informative to help \
    ...
    Make sure to include {delimiter} to separate every step, but EXCLUDE \
    {delimiter} AFTER the response given in Step 3.
    """
